...
import org.kkpa.algorithms.search.BinarySearchRecursive;
...
public class BinarySearchTest {
  ...
  public void testBinarySearchRecursiveFound() {
    ...
    int target = 3;
    assertEquals(2, BinarySearchRecursive.search(testArray, target));
  }
  ...
  public void testBinarySearchRecursiveNotFound() {
    int[] testArray = {1, 2, 3, 4, 5};
    int target = 6;
    assertEquals(-1, BinarySearchRecursive.search(testArray, target));
  }
